...
/* package votacion-0.1.0.0 */
#define VERSION_votacion "0.1.0.0"
#define MIN_VERSION_votacion(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package scotty-cookie-0.1.0.3 */
#define VERSION_scotty_cookie "0.1.0.3"
#define MIN_VERSION_scotty_cookie(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
...
/* package wai-middleware-static-0.8.0 */
#define VERSION_wai_middleware_static "0.8.0"
...
#define CURRENT_COMPONENT_ID "votacion-0.1.0.0"

#define CURRENT_PACKAGE_KEY "votacion-0.1.0.0"
